...
class PostsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($new_post && $new_post instanceof Post) {
            return response()->json(['status_code' => 200, 'message' => 'Post added successfully']);
        }
        return response()->json(['status_code' => 200, 'message' => 'Post did not add successfully']);
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($postItem && $postItem instanceof Post) {
            if ($postItem->user_id == $current_user_id) {
                ...
                return response()->json(['status_code' => 403, 'message' => 'You do not have permission to edit other author posts']);
            }
        }
        return response()->json(['status_code' => 200, 'message' => 'Post did not update successfully']);
    }
